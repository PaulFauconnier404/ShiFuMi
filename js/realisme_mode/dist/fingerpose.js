! function (t, e) {
    ...
    return function (t) {
        ...
        n.r(r), n.d(r, "ScissorsGesture", (function () {
            return A
            ...
            return e = t, (n = [{
                ...
                value: function (t, e) {
                    ...
                    try {
                        for (c.s(); !(n = c.n()).done;) {
                            var f = n.value;
                            u.push([a.getName(f), o.getName(i.curls[f]), l.getName(i.directions[f])])
                        }
                    } catch (t) {
                        c.e(t)
                    } finally {
        ...
        var S = function () {
            ...
            C = new S("scissors");
        C.addCurl(a.Index,o.NoCurl), C.addCurl(a.Middle,o.NoCurl), C.addCurl(a.Ring,o.FullCurl), C.addCurl(a.Ring,o.HalfCurl), C.addCurl(a.Pinky,o.FullCurl), C.addCurl(a.Pinky,o.HalfCurl);
        var A = C, // Signal 
            R = new S("paper"); // Init
            R.addCurl(a.Index, o.NoCurl, 1), R.addCurl(a.Middle, o.NoCurl, 1), R.addCurl(a.Ring, o.NoCurl, 1), R.addCurl(a.Pinky, o.NoCurl, 1), R.addCurl(a.Thumb, o.NoCurl, 1);
        var E1 = R, // Signal
            R1 = new S("rock"); // Init
            R1.addCurl(a.Index, o.FullCurl, 1), R1.addCurl(a.Index, o.HalfCurl, 1), R1.addCurl(a.Middle, o.FullCurl, 1), R1.addCurl(a.Ring, o.FullCurl, 1), R1.addCurl(a.Pinky, o.FullCurl, 1), R1.addCurl(a.Thumb, o.NoCurl, 1), R1.addCurl(a.Thumb, o.HalfCurl, 1), R1.addCurl(a.Pinky, o.FullCurl, 0.9);
        var E = R1; // Signal 
        e.default = {
            GestureEstimator: b,
